<%@ Page Title="Profil" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewProfile.aspx.cs" Inherits="Project_Sharing.ViewProfile" %>

<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <div class="jumbotron">
        <div class="center">
            <h1>
                <asp:Label ID="caption" runat="server" Text="Profil Bilgileri"></asp:Label>
            </h1>
        </div>
    </div>
    <hr />
